...
function closeModal() 
{
  ...
  document.querySelector('#first').style.border = "0.8px solid #ccc";
  document.querySelector('#last').style.border = "0.8px solid #ccc"; 
  document.querySelector('#email').style.border = "0.8px solid #ccc";
  document.querySelector('#birthdate').style.border = "0.8px solid #ccc";
  document.querySelector('#quantity').style.border = "0.8px solid #ccc";    
